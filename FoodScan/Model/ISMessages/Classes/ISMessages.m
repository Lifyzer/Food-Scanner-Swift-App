...
- (void)configureViewForAlertType:(ISAlertType)alertType iconImage:(UIImage*)iconImage {
    if (alertType == ISAlertTypeInfo)
    {
//        UIColor(red: 68/255, green: 176/255, blue: 91/255, alpha: 1.0)
        self.titleLabelTextColor = [UIColor colorWithRed:68.f/255.f green:176.f/255.f blue:91.f/255.f alpha:1.f];
        self.messageLabelTextColor = [UIColor colorWithRed:68.f/255.f green:176.f/255.f blue:91.f/255.f alpha:1.f];
    }
    else
    {
        self.titleLabelTextColor = [UIColor whiteColor];//[UIColor blackColor];//[UIColor whiteColor];
        self.messageLabelTextColor = [UIColor whiteColor];//[UIColor blackColor];//[UIColor whiteColor]
    }
